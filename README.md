...
| Name | Version |
|------|---------|
| <a name="provider_aws"></a> [aws](#provider\_aws) | >= 3.1.0 |
...
| <a name="input_extra_volume_iops"></a> [extra\_volume\_iops](#input\_extra\_volume\_iops) | The volume iops of extra volumes to attach to the EC2 instance (or launch template). Can be a value between `3000` and `64000` (Default: `3000`). | `list(number)` | <pre>[<br>  3000<br>]</pre> | no |
...
| <a name="input_extra_volume_throughput"></a> [extra\_volume\_throughput](#input\_extra\_volume\_throughput) | The volume iops of extra volumes to attach to the EC2 instance (or launch template). Can be a value between `125` and `1000` (Default: `125`). | `list(number)` | <pre>[<br>  125<br>]</pre> | no |
