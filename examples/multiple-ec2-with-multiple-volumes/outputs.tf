output "availability_zones" {
  ...
  value       = "${module.multiple_ec2_with_multiple_volumes.availability_zones}"
}

output "arns" {
  description = "Instance ARNs."
  value       = "${module.multiple_ec2_with_multiple_volumes.arns}"
}

output "credit_specifications" {
  description = "Credit specification of instance."
  value       = "${module.multiple_ec2_with_multiple_volumes.credit_specifications}"
}
...
output "subnet_ids" {
  ...
  value       = "${module.multiple_ec2_with_multiple_volumes.subnet_ids}"
}
